...
export default function Navbar({ onMenuClick }) {
  ...
  return (
    <header className="h-14 glass-dark border-b border-white/5 flex items-center px-4 gap-3 flex-shrink-0">
      ...
      <h1 className="font-display font-semibold text-white flex-1 truncate">{title}</h1>
